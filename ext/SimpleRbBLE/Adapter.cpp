...
void set_adapter_callback_on_scan_found(Adapter* adapterPtr, Object cb) {
...
void fire_adapter_callback_on_scan_found(std::shared_ptr<Adapter> adapter, Peripheral peripheral) {
