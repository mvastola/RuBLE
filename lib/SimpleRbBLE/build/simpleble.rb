...
module SimpleRbBLE
  module Build
    ...
    class SimpleBLE
      DEBUG_MODE = ENV['SIMPLERBBLE_DEBUG_ON'].to_s.strip.length.positive?
      ...
      ASSET_NAME = self.class.os_asset_name
      ...
      def extract_src_path = @extract_src_path ||= EXTRACT_OS_PATH_PRUNE.fetch(os.to_sym).freeze
      ...
      def download!
        ...
        warn "Successfully downloaded #{download_url} to #{download_path.inspect}!"
